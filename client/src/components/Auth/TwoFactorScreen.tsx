      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            disabled={isLoading}
            className="w-full rounded-2xl bg-[#d4258e] px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-[#d4258e] disabled:opacity-80 dark:bg-[#d4258e] dark:hover:bg-[#d4258e]"
          >
